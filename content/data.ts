...
export const achievements = [
  ...
  },
  {
    ...
    title: "Legal Triage Product · 13,000+ hrs/year saved",
    description: "Designed a rules-based triage system on Webex — a structured intake form with conditional logic that decided what needed legal review and what didn't. High-risk: routed to legal with documentation. Low-risk: user got a ready-to-attach artifact and bypassed legal entirely. ~500 queries a month. Owned from concept to rollout.",
    tags: ["Webex", "Rules-based logic", "Legal Ops", "Product ownership"],
  },
  {
    number: "on-prem",
    sublabel: "→ AWS",
